...
RUN apt-get update && \
    ...
    npm install -g openclaw@2026.4.5 opencode-ai@latest clawhub playwright playwright-extra puppeteer-extra-plugin-stealth @steipete/bird && \
    # 安装 bun、uv 和 qmd
...
RUN cd /home/node/.openclaw/extensions && \
  ...
  printf '%s\n' '2026.4.5' > /home/node/.openclaw-seed/extensions/.seed-version && \
